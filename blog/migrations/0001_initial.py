    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('user_key', models.OneToOneField(on_delete=django.db.models.deletion.CASCADE, primary_key=True, related_name='user_prof', serialize=False, to=settings.AUTH_USER_MODEL)),
